...
public class HANARowSchemaGenerator implements SchemaGenerator {

	public static String connection_identifier = "hana-row";
	public static final String schemaPostfix = "ROW";
	...
	public HANARowSchemaGenerator(String db) {
		if (db != null) {
