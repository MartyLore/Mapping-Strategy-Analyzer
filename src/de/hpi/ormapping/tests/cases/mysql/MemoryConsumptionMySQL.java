package de.hpi.ormapping.tests.cases.mysql;
...
public class MemoryConsumptionMySQL extends MemoryConsumption {

	public MemoryConsumptionMySQL() {
		super();
	}

	public MemoryConsumptionMySQL(String db, Hierarchy hierarchy) throws Exception {
		super(db, hierarchy);
	}
