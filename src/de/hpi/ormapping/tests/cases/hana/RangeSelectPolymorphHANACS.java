...
public class RangeSelectPolymorphHANACS extends RangeSelectPolymorph {

	public RangeSelectPolymorphHANACS() {
	}

	public RangeSelectPolymorphHANACS(String db, Hierarchy hierarchy) throws Exception {
		super(db, hierarchy);
	}
