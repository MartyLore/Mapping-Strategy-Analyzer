...
public class MemoryConsumptionHANACS extends MemoryConsumption {

	public MemoryConsumptionHANACS() {
		super();
	}

	public MemoryConsumptionHANACS(String db, Hierarchy hierarchy) throws Exception {
		super(db, hierarchy);
	}
	...
	public String getQueryTemplate(int strategy, ClassNode node) {
		...
		String template = "SELECT round(sum(MEMORY_SIZE_IN_TOTAL)/1024) AS SIZE FROM M_CS_TABLES WHERE SCHEMA_NAME='"+schemaName+"' AND TABLE_NAME='%1$s_";
