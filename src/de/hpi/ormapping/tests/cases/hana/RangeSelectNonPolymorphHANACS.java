...
public class RangeSelectNonPolymorphHANACS extends RangeSelectNonPolymorph {

	public RangeSelectNonPolymorphHANACS() {
	}

	public RangeSelectNonPolymorphHANACS(String db, Hierarchy hierarchy) throws Exception {
		super(db, hierarchy);
	}
