...
public class RangeSelectPolymorph extends TestCaseTemplate {

	public RangeSelectPolymorph() {
	}

	public RangeSelectPolymorph(String db, Hierarchy hierarchy) throws Exception {
		super(db, hierarchy);
	}
